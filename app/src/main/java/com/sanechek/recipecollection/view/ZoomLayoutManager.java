package com.sanechek.recipecollection.view;
...
public class ZoomLayoutManager extends LinearLayoutManager {
    ...
    public ZoomLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
